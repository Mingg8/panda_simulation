...
if __name__ == '__main__':
    ...
    initial = [0, 0, 0, -0.5, 0, 0.5, 0.75] * 100
    publishers = [rospy.Publisher('/panda_arm{}_controller/command'.format(i), Float64, queue_size=1) for i in range(1, 8)]
    ...
    while not rospy.is_shutdown():
        ...
        delta_angle = math.pi / 16 * (math.cos(math.pi / 5 * elapsed.to_sec())) * 100
